...
user5 = User.create(first_name: 'Hunter', last_name: 'Gallagher', email: 'hunter.gallagher@test.com', password: '12345678', role: 'contractor')
user6 = User.create(first_name: 'Ralph', last_name: 'James', email: 'ralph.james@test.com', password: '12345678', role: 'contractor')
user7 = User.create(first_name: 'Aydin', last_name: 'George', email: 'aydin.george@test.com', password: '12345678', role: 'contractor')
user8 = User.create(first_name: 'Miles', last_name: 'Read', email: 'miles.read@test.com', password: '12345678', role: 'contractor')
