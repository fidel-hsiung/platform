      ...
      <Dropdown className='user-filter' show={this.state.filterShow} onToggle={(isOpen, e, metadata)=>this.handleToggle(isOpen, e, metadata)} >
        ...
        <Dropdown.Menu>
          <Form noValidate onSubmit={e=>this.handleSubmit(e)} >
            ...
            <FilterFormMultiSelect label='Role' placeholder='Select role' value={this.state.userFilter.roles} options={[{value: 'employee', label: 'Employee'}, {value: 'contractor', label: 'Contractor'}, {value: 'admin', label: 'Admin'}]} handleChange={value=>this.handleUserFilterInputChange(value, 'roles')} />
